      ...
      <header className="sticky top-0 z-50 border-b border-white/10 bg-black/95 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-8">
          ...
          <div className="flex items-center gap-4">
            <LanguageSwitcher />
            <button onClick={() => handleExternalLink('https://3000-iz2wsrltyzfpy6feydwbz-99421e5c.sg1.manus.computer')} className="border-2 border-[#D4AF37] bg-transparent px-5 py-2 text-sm font-bold text-[#D4AF37] transition hover:bg-[#D4AF37] hover:text-black hover:shadow-[0_0_20px_rgba(212, 175, 55,0.3)]">
